...
public class RegisterServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/newuser?useSSL=false", "root", "root");

            // Prepare the SQL statement
            String sql = "INSERT INTO registration (user_name, passkey, passkey1) VALUES (?, ?, ?)";
